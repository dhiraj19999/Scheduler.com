      ...
      <Box >
        <Flex
          ...
          <Stack
            ...
            flex={{ base: 0, md: 'auto' }}
            ml={{ base: -2 }}
            display={{ base: 'end', md: 'none' ,sm:'end' }}>
            <IconButton
              onClick={onToggle}
              icon={
                isOpen ? <CloseIcon w={3} h={3} /> : <HamburgerIcon w={5} h={5} />
...
import { Box, Button, Flex, Grid, IconButton, Image, Menu, MenuButton, MenuItem, MenuList, Text,} from "@chakra-ui/react";
import navStyle from "./Navbar.module.css";
import PWS from "./logo.png";
...
export default function Navbar() {
  ...
  const { authState,handleLogout, handleLogin } = useContext(AppContext);
  ...
  if (!authState.isAuth) {
    return (
      <div>
        ...
        >
          <Box>
            <Image position="relative" left="30px" src={PWS} h="50px" w="220px" />
          </Box>
          <Flex display={{ base: "none", sm: "none", md: "none", lg: "flex" }}>
            <Menu>
              ...
              <MenuList className={navStyle.productmenu} w={{ base: "", sm: "80vw", md: "100vw" }} p="20px 8%">
                <Box>
                  <Text align={"left"}  mb="20px" fontSize="20px" fontWeight="700">
                    Scheduler products
                  </Text>
                  <Grid templateColumns="repeat(2,1fr)" rowGap="40px">
                    <Flex>
                      <svg
